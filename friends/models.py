...
class FriendshipManager(models.Manager):
    ...
    def sent_requests(self, user) -> QuerySet[FriendshipRequest]:
    ...
    def unaccepted_requests(self, user) -> QuerySet[FriendshipRequest]:
    ...
    def rejected_requests(self, user) -> QuerySet[FriendshipRequest]:
    ...
    def remove_friend(self, from_user, to_user) -> Friend:
        """Remove friend"""
